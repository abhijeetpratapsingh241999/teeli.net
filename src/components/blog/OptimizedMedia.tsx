...
export function OptimizedBlogImage({ 
  ...
  if (error) {
    return (
      <div className={`relative w-full aspect-video bg-gradient-to-br from-gray-900/60 to-gray-800/40 rounded-xl flex items-center justify-center ${className}`}>
  ...
  return (
    <div className={`relative w-full overflow-hidden ${className}`}>
      ...
      {isLoading && (
        <div className="absolute inset-0 bg-gradient-to-br from-gray-900/60 to-gray-800/40 animate-pulse rounded-xl" />
      )}
      ...
      <Image
        ...
        className={`w-full h-auto rounded-xl sm:rounded-2xl border-2 border-cyan-500/30 shadow-2xl transition-opacity duration-500 ${
